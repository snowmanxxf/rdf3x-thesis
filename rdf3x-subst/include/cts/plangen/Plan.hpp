...
{
   /// Possible operators
   enum Op { IndexScan, AggregatedIndexScan, FullyAggregatedIndexScan, NestedLoopJoin, MergeJoin, HashJoin, Substraction, HashGroupify, Filter, Union, MergeUnion, TableFunction, Singleton };
